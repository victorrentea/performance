...
public class MonitorWaitNotifyBasic {
	...
	public static class Sef {
		public void announceComision(String results) {
			...
			PerformanceUtil.log("Announced task");
		}
	}
	
	public static class AngajatModel extends Thread {
		public void waitForTask() {
			PerformanceUtil.log("Waiting for task..");
			
			 PerformanceUtil.sleepMillis(1); // Force thread shift
			// TODO masaTaskuri.wait();
			
			PerformanceUtil.log("Got task to do: " + masaTaskuri.value);
		}
	...
	public static void main(String[] args) throws InterruptedException {
		...
		PerformanceUtil.log("Execution took: " + (System.currentTimeMillis() - t0));
	}
}
