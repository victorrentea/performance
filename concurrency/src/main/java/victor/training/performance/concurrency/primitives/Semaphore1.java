...
public class Semaphore1 {
  // So that only allows a limited number of elements.
  // If you ever try to push more than that,
  // you're going to have to wait for someone to take an element out first.
  static class BoundedHashSet<T> {
    ...
    public BoundedHashSet(int bound) {
      ...
      sem = new Semaphore(bound); // how many am I allowed to push ?
    }
