...
class Worker {
  @SneakyThrows
  @Async // runs on a thread pool with 8 threads, by default in Spring with a work queue of 500
  public void processFile(int taskId, Path tempFile) {
...
//    FileInputStream is;
//    is.
    String contentsString = new String (Files.readAllBytes(tempFile));
