...
//        new Thread(()-> { // Allocated .5 MB
    ...
    ThreadLocalIntro.staticCurrentUser.set(currentUser);
      // end of framework


      // DON'T. except if spawning Virtual Threads = 1kb Executors.ofVirtual()
      String currentUser2 = ThreadLocalIntro.staticCurrentUser.get();
      log.info("INSERT INTO A (data={}, created_by={}) ", data, currentUser2);
    });
  }
}
